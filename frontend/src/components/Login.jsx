...
const Login = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center p-6 bg-[#0a0118] text-white font-sans overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-[#130624]/60 backdrop-blur-2xl rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl shadow-purple-900/50">
        <h1 className="text-5xl font-black text-center mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
          Welcome Back
        </h1>
        ...
        <form onSubmit={handleSubmit(submitHandler)} className="space-y-8">
          ...
          <button
            type="submit"
            disabled={loading}
            className="group relative w-full py-4 rounded-full text-lg font-bold text-white bg-gradient-to-r from-pink-500 via-purple-500 to-violet-600 
